...
document.getElementById("add-money-btn").addEventListener('click', function (e) {
    ...
    if (isNaN(accoutnNumber) || accoutnNumber.length != 11) {
...
document.getElementById("cash-out-btn").addEventListener('click', function (e) {
    ...
    if (isNaN(accoutnNumber) || agentNumber.length != 11) {
        alert("Please provide a valid number!")
        return;
    }
...
document.getElementById("transfer-btn").addEventListener('click', function (e) {
    ...
    if (isNaN(accoutnNumber) || userNumber.length != 11) {
        alert("Please provide a valid number!")
        return;
    }
...
document.getElementById("pay-now-btn").addEventListener('click', function (e) {
    ...
    if (isNaN(accoutnNumber) || accoutnNumber.length != 8) {
...
document.getElementById("transaction-option").addEventListener('click', function(){
    handleToggle("transaction-page")
    handleBg("transaction-option")
})
